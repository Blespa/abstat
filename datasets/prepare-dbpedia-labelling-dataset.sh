...
target_directory="/schema-summaries/data/datasets/labelling-dbpedia-${version}${include_raw}"
...
bunzip2 $triples_directory/mappingbased_properties_cleaned_en.nt.bz2
