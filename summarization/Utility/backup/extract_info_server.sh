...
#}
#End comment1
rm -rf log/* #Rimuovo tutti i file di log
...
echo "---Start: Organize and Split files---"
	...
	splitFile[0]="split -C $dataBlockSize1 $DatasetFile/instance_types_en.nt $tmpDatasetFile/1_lod_part_"
	splitFile[1]="split -C $dataBlockSize2 $DatasetFile/mappingbased_properties_en.nt $tmpDatasetFile/2_lod_part_"
	splitFile[2]="split -C $dataBlockSize3 $DatasetFile/persondata_en.nt $tmpDatasetFile/3_lod_part_" 
	splitFile[3]="split -C $dataBlockSize4 $DatasetFile/specific_mappingbased_properties_en.nt $tmpDatasetFile/4_lod_part_"
